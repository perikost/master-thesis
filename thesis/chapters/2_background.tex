...
% change the language to solidity https://github.com/s-tikhomirov/solidity-latex-highlighting
\begin{lstlisting}[language=C++, label={code: external_function_call}, abovecaptionskip=0pt, caption={Example of an external function call with specified gas.}, captionpos=b]
