...
\vspace{12pt}
\begin{lstlisting}[language=Solidity, label={code: external_function_call}, abovecaptionskip=0pt, caption={Example of an external function call with specified gas \citep{soliditydocs_2023}.}, captionpos=b]
...
% TODO: review : instead of receiving references back to closer nodes
